...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/tracado_1.png", id:"tracado_1"}
	]
};
...
(lib.tracado_1 = function() {
	this.initialize(img.tracado_1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,738,522);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({_off:true},100).wait(1));
	...
	// Camada 3
	this.instance_7 = new lib.tracado_1();
	...
	// Camada 9
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#666666").s().p("Eg59AraMAAAhWzMBz7AAAMAAABWzg");
	this.shape.setTransform(371.1,277.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(101));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(371.1,281,742.2,555.8);
